...
// La cerveza cambia según el día de la semana (semana=individual / finde=pareja).
...
export const MISIONES: Mision[] = [
  ...
  { id: "chela", label: "Cerveza (semana: sin / finde: juntitos)", stat: "templanza", xp: 25, requiereParaDia: true },
...
/** vie/sáb/dom = la cerveza es misión de pareja "juntitos"; resto = individual "sin cerveza". */
